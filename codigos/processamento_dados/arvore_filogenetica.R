...
setwd("~/Documentos/Emily/filogenia")
dir()
...
#Numero de nos internos da arvore: 31515
fish_tree_full[[1]]$Nnode

#Numero total de especies = 31516
...
arvore = read.tree("Mean.tree")
#cex regula o tamanho da fonte
plot(arvore, cex = .6)
dev.off()
